...
class LoginActivity : AppCompatActivity() {
    ...
    internal var LoginURL = "http://10.4.22.209/registerdemo/simplelogin.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnlogin = findViewById<View>(R.id.btnSerach) as Button
        ...
        try {
            ...
            if (jsonObject.getString("status") == "true") {
                ...
                for (i in 0 until dataArray.length()) {
                    ...
                    preferenceHelper!!.putHobby(dataobj.getString("first_name"))
                }
            }
        } catch (e: JSONException) {
            e.printStackTrace()
